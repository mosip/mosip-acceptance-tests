...
public class DeleteDocumentsByPreRegID extends BaseStep implements StepInterface {
    ...
    public RequestDataDTO prepare(){
        String url = "/preregistration/" + System.getProperty("ivv.prereg.version") + "/documents/preregistration/" + store.getCurrentPerson().getPreRegistrationId();
