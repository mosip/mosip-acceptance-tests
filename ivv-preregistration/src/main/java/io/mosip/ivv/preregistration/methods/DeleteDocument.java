...
public class DeleteDocument extends Step implements StepInterface {
    ...
    public void run() {
        ...
        documentID = person.getDocuments().get(index).getDocId();
        ...
        url = "/preregistration/" + System.getProperty("ivv.prereg.version") + "/documents/" + documentID + "?preRegistrationId=" + preRegistrationID;
...
//                            break;
					 ...
					 * "SELECT * FROM applicant_document where id = " +
					 * person.getDocuments().get(0).getDocId();
					 * 
					 * 
					 * 
...
//
    ...
    private String createSQLQuery(Person person) {
    	...
    	sqlQuery.append("SELECT * FROM applicant_document where id =")
