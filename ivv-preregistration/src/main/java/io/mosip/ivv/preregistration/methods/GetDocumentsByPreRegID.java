...
public class GetDocumentsByPreRegID extends BaseStep implements StepInterface {
    ...
    public RequestDataDTO prepare(){
        String url =
                "/preregistration/" + System.getProperty("ivv.prereg.version") + "/documents/" + store.getCurrentPerson().documents.get(0).getDocId()
                        + "?preRegistrationId=" + store.getCurrentPerson().getPreRegistrationId();
