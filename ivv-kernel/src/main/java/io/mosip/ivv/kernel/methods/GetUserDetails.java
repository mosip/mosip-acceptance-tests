...
public class GetUserDetails extends BaseStep implements StepInterface {
    ...
    public RequestDataDTO prepare(){
        String url = "/"+System.getProperty("ivv.global.version")+"/syncdata/userdetails/"+store.getCurrentRegistrationUSer().getCenterId();
    ...
    public ResponseDataDTO call(RequestDataDTO data){
        ...
        Response responseData = (Response) given()
                .cookie("Authorization", store.getHttpData().getCookie())
                .get(data.getUrl());
