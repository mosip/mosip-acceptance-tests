...
public class GetMasterData extends BaseStep implements StepInterface {
    ...
    public RequestDataDTO prepare(){
        String url = "/"+System.getProperty("ivv.global.version")+"/syncdata/masterdata?macaddress="+store.getCurrentRegistrationUSer().getMacAddress();
