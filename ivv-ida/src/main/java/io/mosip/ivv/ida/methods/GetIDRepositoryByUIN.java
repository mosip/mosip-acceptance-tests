...
public class GetIDRepositoryByUIN extends Step implements StepInterface {
    ...
    public void run() {
        ...
        String url = "/idrepository/" + System.getProperty("ivv.global.version") + "/identity/uin/" + uin +"?type=all";
        RestAssured.baseURI = System.getProperty("ivv.mosip.host");
        Response api_response = (Response) given()
                        .cookie("Authorization", this.store.getHttpData().getCookie())
                        .get(url);

        this.callRecord = new CallRecord(RestAssured.baseURI+url, "POST", "uin: "+uin, api_response);
